...
EAPI=6
inherit flag-o-matic autotools poly-c_ebuilds
...
PATCHES=( "${FILESDIR}/${PN}-2.0.12-workaround-ice-ssa-corruption.patch" ) # includes2 bug 590528 patched by upstream, bug 594010
