...
inherit autotools cuda flag-o-matic eapi7-ver multilib-minimal poly-c_ebuilds

REAL_PV=v$(ver_cut 1-2)

DESCRIPTION="displays the hardware topology in convenient formats"
HOMEPAGE="http://www.open-mpi.org/projects/hwloc/"
SRC_URI="http://www.open-mpi.org/software/${PN}/${REAL_PV}/downloads/${MY_P}.tar.bz2"
