...
# $Id: 15974448266129c3c9af2ad5b08ccf718fe21bb3 $

EAPI=5

inherit eutils libtool toolchain-funcs pam multilib autotools poly-c_ebuilds
...
SRC_URI="https://github.com/${PN}-maint/${PN}/archive/${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
