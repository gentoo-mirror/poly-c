...
EAPI="5"
inherit eutils flag-o-matic savedconfig toolchain-funcs multilib poly-c_ebuilds
...
if [[ ${MY_PV} == "9999" ]] ; then
	...
	REAL_P=${PN}-${MY_PV/_/-}
	SRC_URI="https://www.busybox.net/downloads/${REAL_P}.tar.bz2"
...
#	epatch "${FILESDIR}"/${PN}-1.26.2-*.patch
