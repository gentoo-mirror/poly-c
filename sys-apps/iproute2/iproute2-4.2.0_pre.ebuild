...
# $Id: 4fb18ee4aac58c3725894fdaf5f7a60dcf4c629b $

EAPI="5"

inherit eutils toolchain-funcs flag-o-matic multilib poly-c_ebuilds

if [[ ${PV} == "9999" ]] ; then
	EGIT_REPO_URI="git://git.kernel.org/pub/scm/linux/kernel/git/shemminger/iproute2.git"
	inherit git-2
else
	SRC_URI="mirror://kernel/linux/utils/net/${PN}/${MY_P}.tar.xz"
