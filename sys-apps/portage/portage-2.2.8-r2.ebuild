...
# $Id: 755956816f95cb1792dd47e9e24c5548aec3672f $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-make_verbose_slot_rebuild_output_optional.patch" \
		"${FILESDIR}/${P}-fix_unnecessary_slot_rebuilds.patch"
