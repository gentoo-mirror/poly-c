...
# $Id: 5ae86a0fff4754587497f628459df0ae43ab4df5 $
...
if [[ ${PV} == "9999" ]]; then
	...
	SRC_URI+=" https://github.com/OpenRC/openrc/commit/c289774b00d0d7dc38fdc1f0f623569bd184a4b1.patch -> ${PN}-0.21.4-modules-load.d_coments.patch"
fi
...
src_prepare() {
	...
	eapply "${DISTDIR}/${P}-modules-load.d_coments.patch"
