...
inherit perl-functions systemd toolchain-funcs user eapi7-ver poly-c_ebuilds

REAL_P="Mail-SpamAssassin-${MY_PV//_/-}"
S="${WORKDIR}/${REAL_P}"
DESCRIPTION="An extensible mail filter which can identify and tag spam"
HOMEPAGE="https://spamassassin.apache.org/"
SRC_URI="mirror://apache/spamassassin/source/${REAL_P}.tar.bz2"
