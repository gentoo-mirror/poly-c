...
# $Id: cd993af0db33b375c62dac01c870c2933d7131ea $
...
#SRC_URI="https://github.com/distcc/distcc/releases/download/v${MY_PV}/${MY_P}.tar.gz -> ${MY_P}.tar"
SRC_URI="https://github.com/distcc/distcc/releases/download/v${MY_PV}/${MY_P}.tar.gz"
