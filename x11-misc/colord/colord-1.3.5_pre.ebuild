...
# $Id: 294e450c62038b2cce7d1aa863fd56ae7d1a8ec8 $

EAPI=6
GNOME2_LA_PUNT="yes"
VALA_USE_DEPEND="vapigen"

inherit autotools bash-completion-r1 check-reqs gnome2 user systemd udev vala multilib-minimal poly-c_ebuilds

DESCRIPTION="System service to accurately color manage input and output devices"
HOMEPAGE="https://www.freedesktop.org/software/colord/"
SRC_URI="https://www.freedesktop.org/software/colord/releases/${MY_P}.tar.xz"
