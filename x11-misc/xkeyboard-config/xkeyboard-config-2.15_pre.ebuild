...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/xkeyboard-config/xkeyboard-config-2.14.ebuild,v 1.10 2015/03/14 14:29:06 maekke Exp $

EAPI=5

XORG_STATIC=no
inherit xorg-2 poly-c_ebuilds

EGIT_REPO_URI="git://anongit.freedesktop.org/git/xkeyboard-config"

DESCRIPTION="X keyboard configuration database"
HOMEPAGE="http://www.freedesktop.org/wiki/Software/XKeyboardConfig"
[[ ${PV} == *9999* ]] || SRC_URI="${XORG_BASE_INDIVIDUAL_URI}/data/${PN}/${MY_P}.tar.bz2"
