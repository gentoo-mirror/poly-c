...
inherit cmake l10n systemd user poly-c_ebuilds
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-0.19.0-pam-1.4-substack.patch"
)
...
src_install() {
	...
	dodir ${confd}
	"${ED}"/usr/bin/sddm --example-config > "${ED}/${confd}"/00default.conf \
