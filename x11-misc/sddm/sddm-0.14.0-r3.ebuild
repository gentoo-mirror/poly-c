...
# $Id: 5a2d25ea53488aca1d8419c56ad9825ea7fcf8b6 $
...
PATCHES=(
	...
	"${DISTDIR}/${P}-nsswitch_conf.patch"
)

# Fix for nsswitch.conf for >=glibc-2.26
SRC_URI+=" https://github.com/sddm/sddm/commit/1f39c7a91ea4bc9527628adb01cb49173f1e68be.patch -> ${PN}-0.14.0-nsswitch_conf.patch"
