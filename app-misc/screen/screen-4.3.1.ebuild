...
# $Id: 48a082b5100cbb87bbc7572bd5e7eb6b152de295 $
...
SRC_URI="mirror://gnu/${PN}/${P}.tar.gz
	http://git.savannah.gnu.org/cgit/screen.git/patch/?id=b7484c224738247b510ed0d268cd577076958f1b -> ${PN}-4.3.1-recursion_stack_overflow_fix.patch"
...
src_prepare() {
	...
	epatch "${DISTDIR}/${P}-recursion_stack_overflow_fix.patch"
