...
inherit eutils qmake-utils systemd toolchain-funcs readme.gentoo-r1 poly-c_ebuilds
...
if [ "${MY_PV}" = "9999" ]; then
	...
	SRC_URI="https://w1.fi/releases/${MY_P}.tar.gz"
fi
...
src_prepare() {
	...
	if use wimax; then
		...
		eapply "${FILESDIR}/${PN}-2.8-generate-libeap-peer.patch"
