...
EAPI=6
inherit flag-o-matic linux-info systemd poly-c_ebuilds
...
if [[ ${MY_PV} == *9999* ]]; then
	...
	SRC_URI="https://www.kernel.org/pub/linux/network/wireless/${MY_P}.tar.xz"
...
[[ ${MY_PV} == *9999* ]] && DEPEND+=" dev-python/docutils"
...
src_configure() {
	...
	[[ ${MY_PV} == *9999* ]] || myeconfargs+=(--enable-external-ell)
	econf "${myeconfargs[@]}"
}
