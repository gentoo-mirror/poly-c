...
src_prepare() {
	if full_tarball; then
		eapply "${FILESDIR}/${PN}-3.11.0-full_tarball-build.patch"
		eapply "${FILESDIR}/${PN}-3.11.0-full_tarball-SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER.patch"
		...
		eapply "${FILESDIR}/${PN}-3.11.0-nonfull_tarball-build.patch"
		eapply "${FILESDIR}/${PN}-3.11.0-nonfull_tarball-SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER.patch"
	fi
