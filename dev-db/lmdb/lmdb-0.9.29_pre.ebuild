...
EAPI=7
inherit flag-o-matic multilib-minimal toolchain-funcs poly-c_ebuilds

REAL_P="${PN^^}_${MY_PV}"

DESCRIPTION="An ultra-fast, ultra-compact key-value embedded data store"
HOMEPAGE="https://symas.com/lmdb/technical/"
SRC_URI="https://git.openldap.org/openldap/openldap/-/archive/${REAL_P}/openldap-${REAL_P}.tar.gz"
...
S="${WORKDIR}/openldap-${REAL_P}/libraries/liblmdb"
...
multilib_src_install() {
	...
	sed -i -e "s!@PACKAGE_VERSION@!${MY_PV}!" \
