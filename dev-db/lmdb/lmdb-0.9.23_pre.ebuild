...
EAPI=7
inherit toolchain-funcs flag-o-matic multilib-minimal poly-c_ebuilds

DESCRIPTION="An ultra-fast, ultra-compact key-value embedded data store"
HOMEPAGE="http://symas.com/mdb/"
SRC_URI="https://github.com/LMDB/lmdb/archive/LMDB_${MY_PV}.tar.gz"
...
S="${WORKDIR}/${PN}-LMDB_${MY_PV}/libraries/liblmdb"
