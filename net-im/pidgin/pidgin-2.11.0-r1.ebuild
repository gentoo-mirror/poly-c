...
# $Id: a645995680a21fc65ace814473fdfcebb3ead89d $
...
IUSE+=" networkmanager nls perl pie silc ssl tcl tk spell gadu sasl ncurses"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-2.7.4-icq-html-regression.patch"
)
