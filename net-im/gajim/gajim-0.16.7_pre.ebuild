...
inherit autotools-utils python-r1 versionator poly-c_ebuilds
...
SRC_URI="
	http://www.gajim.org/downloads/$(get_version_component_range 1-2)/${REAL_P}.tar.bz2"
#	test? ( https://dev.gentoo.org/~jlec/distfiles/${PN}-tests-${MY_PV}.tar.xz )"
