...
inherit eutils toolchain-funcs multilib-minimal poly-c_ebuilds
...
SRC_URI="mirror://gnu/binutils/${REAL_P}.tar.bz2
	mirror://gentoo/${REAL_PN}-2.29-patches-${PATCHVER}.tar.xz"

LICENSE="|| ( GPL-3 LGPL-3 )"
# The shared lib SONAMEs use the ${MY_PV} in them.
SLOT="0/${MY_PV}"
