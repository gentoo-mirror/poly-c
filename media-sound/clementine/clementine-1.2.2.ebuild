...
# $Header: /var/cvsroot/gentoo-x86/media-sound/clementine/clementine-1.2.2.ebuild,v 1.7 2015/07/12 03:41:29 idella4 Exp $
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-1.2.1-libraryquery.patch
	"${FILESDIR}"/${P}-use_internal_sha2.patch
)
