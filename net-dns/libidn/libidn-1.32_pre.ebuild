...
# $Header: /var/cvsroot/gentoo-x86/net-dns/libidn/libidn-1.31.ebuild,v 1.1 2015/07/09 05:03:41 jer Exp $

EAPI=5
inherit elisp-common java-pkg-opt-2 mono-env multilib-minimal poly-c_ebuilds
...
multilib_src_install() {
	...
	if multilib_is_native_abi && use java; then
		java-pkg_newjar java/${MY_P}.jar ${PN}.jar || die
