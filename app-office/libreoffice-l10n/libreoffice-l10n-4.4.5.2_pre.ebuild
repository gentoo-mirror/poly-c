...
BASE_SRC_URI="http://download.documentfoundation.org/${PN/-l10n/}/stable/${REAL_PV}/rpm"
...
for lang in ${LANGUAGES_HELP}; do
	...
	helppack="offlinehelp? ( ${BASE_SRC_URI}/x86/LibreOffice_${REAL_PV}_Linux_x86_rpm_helppack_${lang2/_/-}.tar.gz )"
	SRC_URI+=" linguas_${lang}? ( ${helppack} )"
done
for lang in ${LANGUAGES}; do
	langpack=""
	[[ ${lang} == en ]] \
		|| langpack="${BASE_SRC_URI}/x86/LibreOffice_${REAL_PV}_Linux_x86_rpm_langpack_${lang/_/-}.tar.gz"
