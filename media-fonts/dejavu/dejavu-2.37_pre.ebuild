...
# $Id: a7e8968de215242001f7f7fc957f711432773dc2 $

EAPI=6
inherit font versionator poly-c_ebuilds
...
MY_PV=$(get_version_component_range 1-2 ${MY_PV})
snapv=$(get_version_component_range 3-4 ${MY_PV})
snapv=${snapv/./-}
