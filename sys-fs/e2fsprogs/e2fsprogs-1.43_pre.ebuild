...
inherit eutils flag-o-matic multilib toolchain-funcs poly-c_ebuilds

DESCRIPTION="Standard EXT2/EXT3/EXT4 filesystem utilities"
HOMEPAGE="http://e2fsprogs.sourceforge.net/"
SRC_URI="mirror://sourceforge/e2fsprogs/${MY_P}.tar.xz
	mirror://kernel/linux/kernel/people/tytso/${PN}/v${MY_PV}/${MY_P}.tar.xz
...
src_prepare() {
	...
	if [[ ${CHOST} == *-mint* ]] ; then
		eapply "${WORKDIR}"/${PN}-1.42.9-mint-r1.patch
	fi
