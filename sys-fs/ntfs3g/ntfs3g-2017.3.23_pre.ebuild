...
EAPI=5
inherit eutils linux-info udev toolchain-funcs libtool poly-c_ebuilds

REAL_PN=${PN/3g/-3g}
REAL_P=${REAL_PN}_ntfsprogs-${MY_PV}

DESCRIPTION="Open source read-write NTFS driver that runs under FUSE"
HOMEPAGE="http://www.tuxera.com/community/ntfs-3g-download/"
SRC_URI="http://tuxera.com/opensource/${REAL_P}.tgz"
...
src_install() {
	...
	use suid && fperms u+s /usr/bin/${REAL_PN}
