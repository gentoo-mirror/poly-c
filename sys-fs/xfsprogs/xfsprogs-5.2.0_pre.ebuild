...
inherit toolchain-funcs multilib systemd usr-ldscript poly-c_ebuilds

DESCRIPTION="xfs filesystem utilities"
HOMEPAGE="https://xfs.wiki.kernel.org/"
SRC_URI="https://www.kernel.org/pub/linux/utils/fs/xfs/${PN}/${MY_P}.tar.xz"
...
PATCHES=(
	...
	"${FILESDIR}"/${MY_P}-revert-ag_health_via_ag_geometry_ioctl.patch
)
