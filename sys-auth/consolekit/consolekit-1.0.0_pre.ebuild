...
# $Id: 797cd354cd8cf980fdf73437c4f65c2a15540429 $

EAPI=5
inherit eutils linux-info pam poly-c_ebuilds
...
SRC_URI="http://github.com/${MY_PN}/${MY_PN}/releases/download/${MY_PV}/${MY_P}.tar.bz2
...
src_install() {
	...
	newinitd "${FILESDIR}"/${PN}-0.3.rc consolekit
