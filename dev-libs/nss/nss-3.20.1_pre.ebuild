...
EAPI=5
inherit eutils flag-o-matic multilib toolchain-funcs multilib-minimal poly-c_ebuilds

NSPR_VER="4.10.10"
RTM_NAME="NSS_${MY_PV//./_}_RTM"
...
SRC_URI="http://archive.mozilla.org/pub/mozilla.org/security/nss/releases/${RTM_NAME}/src/${MY_P}.tar.gz
