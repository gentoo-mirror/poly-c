...
inherit autotools libtool ltprune multilib-minimal toolchain-funcs $GIT_ECLASS poly-c_ebuilds
...
if [[ $PV = 9999* ]]; then
	...
	SRC_URI="https://wayland.freedesktop.org/releases/${MY_P}.tar.xz"
