...
inherit eutils libtool toolchain-funcs multilib-minimal poly-c_ebuilds
...
SRC_URI="ftp://ftp.gmplib.org/pub/${MY_P}/${MY_P}.tar.xz
	...
	doc? ( https://gmplib.org/${PN}-man-${DOC_PV}.pdf )"
...
multilib_src_install_all() {
	einstalldocs
	use doc && cp "${DISTDIR}"/gmp-man-${DOC_PV}.pdf "${D}"/usr/share/doc/${PF}/
}
