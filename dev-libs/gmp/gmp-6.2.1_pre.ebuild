...
inherit flag-o-matic eutils libtool multilib-minimal toolchain-funcs poly-c_ebuilds
...
SRC_URI="ftp://ftp.gmplib.org/pub/${REAL_P}/${REAL_P}.tar.xz
	mirror://gnu/${PN}/${REAL_P}.tar.xz
	doc? ( https://gmplib.org/${PN}-man-6.2.0.pdf )"
...
multilib_src_install_all() {
	einstalldocs
	use doc && cp "${DISTDIR}"/gmp-man-${REAL_PV}.pdf "${ED}"/usr/share/doc/${PF}/
}
