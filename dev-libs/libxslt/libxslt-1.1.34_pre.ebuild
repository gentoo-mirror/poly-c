...
inherit autotools ltprune python-r1 toolchain-funcs multilib-minimal poly-c_ebuilds

DESCRIPTION="XSLT libraries and tools"
HOMEPAGE="http://www.xmlsoft.org/"
SRC_URI="ftp://xmlsoft.org/${PN}/${MY_P}.tar.gz"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/1.1.34-simplify-python.patch
