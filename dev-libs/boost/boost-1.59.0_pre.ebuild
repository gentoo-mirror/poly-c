...
inherit eutils flag-o-matic multilib multiprocessing python-r1 toolchain-funcs versionator multilib-minimal poly-c_ebuilds

MY_P="${PN}_$(replace_all_version_separators _ ${MY_PV})"
MAJOR_V="$(get_version_component_range 1-2 ${MY_PV})"
...
LICENSE="Boost-1.0"
SLOT="0/${MY_PV}" # ${PV} instead ${MAJOR_V} due to bug 486122
...
DEPEND="${RDEPEND}
	|| ( =dev-util/boost-build-${MAJOR_V}* ~dev-util/boost-build-${PV} )"
REQUIRED_USE="
	mpi? ( threads )
