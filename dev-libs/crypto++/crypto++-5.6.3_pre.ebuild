...
inherit eutils flag-o-matic multilib toolchain-funcs autotools poly-c_ebuilds

DESCRIPTION="C++ class library of cryptographic schemes"
HOMEPAGE="http://cryptopp.com"
SRC_URI="mirror://sourceforge/cryptopp/cryptopp${MY_PV//.}.zip"
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-5.6.3-make.patch
