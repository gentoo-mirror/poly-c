...
# $Id: 33d31cf261c195b4e24af191a6ac521c495ae8cf $
...
inherit toolchain-funcs versionator python-r1 mono-env ruby-ng db-use-r1
...
src_configure() {
	...
	sed -i \
		...
		-e "s|\(DB_LIBS[[:space:]]*=\) \-ldb_cxx|\1 -ldb_cxx-$(db_findver)|" \
