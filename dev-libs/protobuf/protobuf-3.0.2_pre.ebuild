...
inherit python-r1 autotools flag-o-matic toolchain-funcs elisp-common multilib-minimal poly-c_ebuilds
...
SRC_URI="https://github.com/google/protobuf/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
