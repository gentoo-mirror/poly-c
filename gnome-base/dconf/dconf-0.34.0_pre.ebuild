...
EAPI=7
inherit bash-completion-r1 gnome.org gnome2-utils meson virtualx xdg poly-c_gnome
...
PATCHES=(
	...
	"${FILESDIR}"/${MY_P}-remove_libdconf_common_hidden.patch
	"${FILESDIR}"/${MY_P}-libdconf_visible_symbols.patch
)
