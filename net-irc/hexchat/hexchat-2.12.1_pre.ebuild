...
inherit fdo-mime gnome2-utils mono-env multilib python-single-r1 poly-c_ebuilds
...
if [[ "${PV}" == "9999" ]] ; then
	...
	SRC_URI="https://dl.hexchat.net/hexchat/${MY_P}.tar.xz"
	KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~sparc ~x86 ~amd64-linux"
fi

LICENSE="GPL-2 plugin-fishlim? ( MIT )"
SLOT="0"
IUSE="dbus debug +gtk libcanberra libnotify libproxy libressl lua nls perl +plugins plugin-checksum plugin-doat plugin-fishlim plugin-sysinfo python spell ssl theme-manager"
REQUIRED_USE="
