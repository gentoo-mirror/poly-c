...
inherit autotools eutils flag-o-matic perl-module toolchain-funcs poly-c_ebuilds
...
SRC_URI="https://github.com/irssi/irssi/releases/download/${MY_PV/_/-}/${MY_P}.tar.xz"
