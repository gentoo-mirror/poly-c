...
inherit bash-completion-r1 distutils-r1 eutils flag-o-matic versionator l10n poly-c_ebuilds

MY_P=${PN}-${MY_PV}

SERIES=$(get_version_component_range 1-2)
SRC_URI="https://launchpad.net/bzr/${SERIES}/${MY_PV}/+download/${MY_P}.tar.gz"
