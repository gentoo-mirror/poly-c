...
inherit autotools eutils toolchain-funcs flag-o-matic user systemd poly-c_ebuilds

MY_P=${MY_P/_p/p}
DESCRIPTION="Network Time Protocol suite/programs"
HOMEPAGE="http://www.ntp.org/"
SRC_URI="http://www.eecis.udel.edu/~ntp/ntp_spool/ntp4/ntp-${MY_PV:0:3}/${MY_P}.tar.gz
	mirror://gentoo/${PN}-4.2.8p3-manpages.tar.bz2"
