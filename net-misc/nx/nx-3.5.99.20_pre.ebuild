...
SRC_URI="http://code.x2go.org/releases/source/nx-libs/nx-libs-${MY_PV}-1-full.tar.gz"
...
src_prepare() {
	...
	sed '/^[[:space:]]*$(MAKE) -C nxdialog install/d' -i Makefile || die
