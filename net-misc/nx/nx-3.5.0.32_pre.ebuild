...
EAPI=5
inherit autotools eutils multilib readme.gentoo poly-c_ebuilds

DESCRIPTION="NX compression technology core libraries"
HOMEPAGE="http://www.x2go.org/doku.php/wiki:libs:nx-libs"

SRC_URI="http://code.x2go.org/releases/source/nx-libs/nx-libs-${MY_PV}-full.tar.gz"
