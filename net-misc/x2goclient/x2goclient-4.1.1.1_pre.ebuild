...
inherit eutils gnome2-utils qmake-utils poly-c_ebuilds

DESCRIPTION="The X2Go Qt client"
HOMEPAGE="http://www.x2go.org"
SRC_URI="http://code.x2go.org/releases/source/${PN}/${MY_P}.tar.gz"
...
CLIENT_BUILD="${WORKDIR}"/${MY_P}.client_build
PLUGIN_BUILD="${WORKDIR}"/${MY_P}.plugin_build
