...
# $Id: 9df5af61a189e33e5d5c7b322e42db6a7586b02d $

EAPI=6
inherit autotools eutils flag-o-matic

DEB_P="${PN}_${PV}-8.debian"
...
SRC_URI="ftp://ftp.afterstep.org/stable/AfterStep-${PV}.tar.bz2
	...
	mirror://debian/pool/main/a/${PN}/${DEB_P}.tar.xz"
...
src_prepare() {
	local debpatch
	for debpatch in $(<"${WORKDIR}"/debian/patches/series) ; do
		eapply "${WORKDIR}"/debian/patches/${debpatch}
	done
	default
