...
# $Header: /var/cvsroot/gentoo-x86/lxde-base/lxsession/lxsession-0.4.9.2-r2.ebuild,v 1.3 2014/05/31 22:20:19 ssuominen Exp $
...
src_prepare() {
	...
	use policykit \
		|| epatch "${FILESDIR}"/${P}-remove_polkit_dependency.patch
