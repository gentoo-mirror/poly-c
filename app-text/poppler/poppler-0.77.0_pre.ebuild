...
inherit cmake-utils flag-o-matic toolchain-funcs xdg-utils poly-c_ebuilds
...
if [[ ${MY_PV} == *9999* ]] ; then
	...
	SRC_URI="https://poppler.freedesktop.org/${MY_P}.tar.xz"
...
src_install() {
	...
	if use cairo && use doc && [[ ${MY_PV} != *9999* ]]; then
