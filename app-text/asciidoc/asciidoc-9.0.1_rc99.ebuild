...
inherit autotools eutils python-single-r1 readme.gentoo-r1 poly-c_ebuilds poly-c_ebuilds

DESCRIPTION="A plain text human readable/writable document format"
HOMEPAGE="http://asciidoc.org/ https://github.com/asciidoc/asciidoc-py3/"
SRC_URI="https://github.com/${PN}/${PN}-py3/archive/${MY_PV/_/}.tar.gz -> ${MY_P}.tar.gz"
