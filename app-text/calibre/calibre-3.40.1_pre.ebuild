...
inherit eutils bash-completion-r1 gnome2-utils multilib toolchain-funcs python-single-r1 xdg-utils poly-c_ebuilds

DESCRIPTION="Ebook management application"
HOMEPAGE="https://calibre-ebook.com/"
SRC_URI="https://download.calibre-ebook.com/${MY_PV}/${MY_P}.tar.xz"
...
src_prepare() {
	...
	#sed -e "s#\\(^numeric_version =\\).*#\\1 (${MY_PV//./, })#" \
