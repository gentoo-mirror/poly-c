...
inherit eutils multilib user systemd toolchain-funcs poly-c_ebuilds

DESCRIPTION="Single process stack of various system monitors"
HOMEPAGE="http://www.gkrellm.net/"
SRC_URI="http://gkrellm.srcbox.net/${MY_P/_/-}.tar.bz2"
...
PATCHES=(
	...
	"${FILESDIR}"/${MY_P}-fix_gtk_deprecation_warning.patch
	"${FILESDIR}"/${MY_P}-fix_copypaste_error.patch
	"${FILESDIR}"/${MY_P}-avoid_possible_busy_loop.patch
	"${FILESDIR}"/${MY_P}-update_german_translation.patch
)
