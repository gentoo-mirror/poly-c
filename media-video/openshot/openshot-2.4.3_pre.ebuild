...
inherit distutils-r1 gnome2-utils versionator xdg-utils poly-c_ebuilds
...
#SRC_URI="https://launchpad.net/${PN}/$(get_version_component_range 1-2)/${MY_PV}/+download/${REAL_P}.tar.gz"
SRC_URI="https://github.com/OpenShot/openshot-qt/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
