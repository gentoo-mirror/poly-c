...
inherit cmake-utils python-single-r1 xdg-utils poly-c_ebuilds
...
if [[ ${MY_PV} == *9999 ]]; then
	...
	SRC_URI="https://github.com/obsproject/${PN}/archive/${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
