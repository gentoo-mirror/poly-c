...
if [[ ${PV} = 9999 ]]; then
	...
	SRC_URI+=" https://github.com/MaartenBaert/ssr/commit/853863a04c58539cc6d2a4ee680753d8618aa5a6.patch -> ${PN}-0.3.6-missing_include.patch"
fi
...
PATCHES=(
	"${DISTDIR}/${P}-missing_include.patch"
)
