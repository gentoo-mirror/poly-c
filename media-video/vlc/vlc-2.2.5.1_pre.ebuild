...
inherit autotools flag-o-matic toolchain-funcs versionator virtualx ${SCM} poly-c_ebuilds

REAL_PV="${MY_PV/_/-}"
REAL_PV="${REAL_PV/-beta/-test}"
REAL_P="${PN}-${REAL_PV}"

DESCRIPTION="VLC media player - Video player and streamer"
HOMEPAGE="http://www.videolan.org/vlc/"
if [[ ${MY_PV} = *9999 ]] ; then # Live ebuild
	SRC_URI=""
elif [[ "${REAL_P}" == "${MY_P}" ]]; then
	SRC_URI="http://download.videolan.org/pub/videolan/${PN}/${MY_PV}/${MY_P}.tar.xz"
else
	SRC_URI="http://download.videolan.org/pub/videolan/testing/${REAL_P}/${REAL_P}.tar.xz"
fi
