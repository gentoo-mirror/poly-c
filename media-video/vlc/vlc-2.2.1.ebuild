...
if [ "${PV%9999}" != "${PV}" ] ; then # Live ebuild
	...
	SRC_URI="http://download.videolan.org/pub/videolan/${PN}/${PV}/${P}.tar.xz
		https://git.videolan.org/?p=vlc/vlc-2.2.git;a=patch;h=ce91452460a75d7424b165c4dc8db98114c3cbd9;hp=9e12195d3e4316278af1fa4bcb6a705ff27456fd -> ${PN}-2.2.1-demux_mp4.patch"
else
...
src_prepare() {
	...
	# 558418
	epatch "${DISTDIR}/${P}-demux_mp4.patch"
