...
# $Id: bf557fc35eb2c928048ebccc804d16411bffb99d $
...
"
if [ "${PV#9999}" = "${PV}" ] ; then
	KEYWORDS="~amd64 ~arm ~arm64 ~ia64 ~mips ~ppc64 ~sparc ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~x64-solaris ~x86-solaris"
fi
