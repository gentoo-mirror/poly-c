...
# $Id: ab7554a66bcec0c4815c5db560fae695d492ab23 $
...
"
if [ "${PV#9999}" = "${PV}" ] ; then
	KEYWORDS="~amd64 ~arm ~arm64 ~ia64 ~mips ~ppc64 ~sparc ~x86 ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~x64-solaris ~x86-solaris"
fi
