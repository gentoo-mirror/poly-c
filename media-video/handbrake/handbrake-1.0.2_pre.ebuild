...
inherit autotools eutils gnome2-utils python-any-r1 poly-c_ebuilds
...
if [[ ${MY_PV} = *9999* ]]; then
	...
	SRC_URI="http://handbrake.fr/rotation.php?file=${REAL_P}.tar.bz2 -> ${MY_P}.tar.bz2"
	S="${WORKDIR}/${REAL_P}"
	KEYWORDS="~amd64 ~x86"
fi
...
src_prepare() {
	...
	# This breaks with system libbluray
	eapply -R "${FILESDIR}/${PN}-1.0.0-revert_libbluray_incompatibility.patch"
...
src_install() {
	...
	dodoc {AUTHORS,NEWS,THANKS}.markdown
}
