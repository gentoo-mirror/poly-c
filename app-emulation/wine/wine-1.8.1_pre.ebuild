...
inherit autotools-utils eutils fdo-mime flag-o-matic gnome2-utils l10n multilib multilib-minimal pax-utils toolchain-funcs virtualx versionator poly-c_ebuilds
...
if [[ ${PV} == "9999" ]] ; then
	...
	SRC_URI="${SRC_URI}
	staging? ( https://github.com/wine-compholio/wine-staging/archive/v${MY_PV}-unofficial.tar.gz -> ${STAGING_P}.tar.gz )"
fi
