...
inherit db-use eutils flag-o-matic multilib multilib-minimal ssl-cert versionator toolchain-funcs autotools user systemd poly-c_ebuilds
...
SRC_URI="ftp://ftp.openldap.org/pub/OpenLDAP/openldap-release/${MY_P}.tgz
		 mirror://gentoo/${BIS_P}"
