...
inherit autotools db-use flag-o-matic multilib-minimal preserve-libs ssl-cert toolchain-funcs systemd tmpfiles poly-c_ebuilds
...
SRC_URI="
	https://openldap.org/software/download/OpenLDAP/openldap-release/${MY_P}.tgz
	http://gpl.savoirfairelinux.net/pub/mirrors/openldap/openldap-release/${MY_P}.tgz
	http://repository.linagora.org/OpenLDAP/openldap-release/${MY_P}.tgz
	http://mirror.eu.oneandone.net/software/openldap/openldap-release/${MY_P}.tgz
	mirror://gentoo/${BIS_P}"
