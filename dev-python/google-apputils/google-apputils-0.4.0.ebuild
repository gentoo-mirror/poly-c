...
# $Header: /var/cvsroot/gentoo-x86/dev-python/google-apputils/google-apputils-0.4.0.ebuild,v 1.9 2015/06/07 09:30:31 maekke Exp $
...
python_prepare_all() {
	epatch "${FILESDIR}/${P}-over_strict_dependency_fix.patch.xz"
