...
MOZ_SRC_BASE_URI="https://github.com/MrAlex94/Waterfox/archive"
MY_PV="G3.${PV}"
MY_P="Waterfox-G3.${PV}"
...
SRC_URI="${MOZ_SRC_BASE_URI}/${MY_PV}.tar.gz -> ${P}.tar.gz
	${PATCH_URIS[@]}"
...
src_prepare() {
	...
	rm "${WORKDIR}/firefox-patches/0038-bmo-1667736-Update-packed_simd-to-compile-on-Rust-1..patch" \
		|| die
