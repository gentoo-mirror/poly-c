...
inherit eutils fdo-mime gnome2-utils pax-utils python-any-r1 cmake-utils vala poly-c_ebuilds

KEYWORDS="~amd64 ~arm ~mips ~x86 ~x86-fbsd"
SRC_URI="http://www.${PN}-browser.org/downloads/${PN}_${MY_PV}_all_.tar.bz2"
...
src_prepare() {
	epatch "${FILESDIR}/${MY_P}-fix-webkit2-build-breakage.patch"
	vala_src_prepare
