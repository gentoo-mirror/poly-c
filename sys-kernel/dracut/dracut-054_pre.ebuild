...
inherit bash-completion-r1 linux-info optfeature systemd toolchain-funcs poly-c_ebuilds
...
if [[ ${MY_PV} == 9999 ]] ; then
	...
	SRC_URI="https://www.kernel.org/pub/linux/utils/boot/${PN}/${MY_P}.tar.xz"
fi
...
src_configure() {
	...
	if [[ ${MY_PV} != 9999 && ! -f dracut-version.sh ]] ; then
		# Source tarball from github doesn't include this file
		echo "DRACUT_VERSION=${MY_PV}" > dracut-version.sh || die
	fi
}
