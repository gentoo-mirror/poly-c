...
inherit toolchain-funcs autotools poly-c_ebuilds

DESCRIPTION="A collection of several tools related to OpenPGP"
HOMEPAGE="http://pgp-tools.alioth.debian.org/"
SRC_URI="mirror://debian/pool/main/s/signing-party/${PN}_${MY_PV}.orig.tar.gz"
...
src_prepare() {
	...
	sed -i "s:/usr/share/doc/signing-party/caff/caffrc.sample:${EPREFIX}/usr/share/doc/${MY_P}/caff/caffrc.sample.gz:g" \
		caff/caff || die
