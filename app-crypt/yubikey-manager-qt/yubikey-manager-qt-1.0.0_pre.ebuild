...
inherit eutils qmake-utils python-single-r1 poly-c_ebuilds

DESCRIPTION="Cross-platform application for configuring any YubiKey over all USB transports"
HOMEPAGE="https://developers.yubico.com/yubikey-manager-qt https://github.com/Yubico/yubikey-manager-qt"
#SRC_URI="https://github.com/Yubico/yubikey-manager-qt/releases/download/${MY_P}/${MY_P}.tar.gz"
SRC_URI="https://developers.yubico.com/yubikey-manager-qt/Releases/${MY_P}.tar.gz"
...
DEPEND="
	>=app-crypt/yubikey-manager-1.0.0_pre[${PYTHON_USEDEP}]
	<app-crypt/yubikey-manager-1.1.0
