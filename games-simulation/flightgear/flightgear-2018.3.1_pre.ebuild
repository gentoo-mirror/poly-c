...
inherit cmake-utils bash-completion-r1 toolchain-funcs poly-c_ebuilds

DESCRIPTION="Open Source Flight Simulator"
HOMEPAGE="http://www.flightgear.org/"
SRC_URI="mirror://sourceforge/flightgear/${MY_P}.tar.bz2"
...
PATCHES=("${FILESDIR}/${PN}-2018.3.1-cmake.patch")
