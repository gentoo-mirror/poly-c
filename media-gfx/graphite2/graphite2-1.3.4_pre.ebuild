...
inherit eutils perl-module python-any-r1 cmake-multilib poly-c_ebuilds

DESCRIPTION="Library providing rendering capabilities for complex non-Roman writing systems"
HOMEPAGE="http://graphite.sil.org/"
SRC_URI="https://github.com/silnrsi/graphite/archive/${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
...
PATCHES=(
	"${FILESDIR}/${PN}-1.3.3-includes-libs-perl.patch"
)
