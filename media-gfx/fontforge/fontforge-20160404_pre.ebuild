...
inherit autotools eutils fdo-mime python-single-r1 poly-c_ebuilds

DESCRIPTION="postscript font editor and converter"
HOMEPAGE="http://fontforge.github.io/"
SRC_URI="https://github.com/fontforge/fontforge/releases/download/${MY_PV}/${PN}-dist-${MY_PV}.tar.gz"

# Upstream patches
SRC_URI+=" https://github.com/fontforge/fontforge/commit/63def02823e631cd73b763541a87d7c480be799e.patch -> ${PN}-20160404-add_dummy_spiros.patch"
...
S="${WORKDIR}/${PN}-2.0.20140101"

PATCHES=(
	"${FILESDIR}"/fontforge-dummy-spiro.patch
	"${DISTDIR}"/${MY_P}-add_dummy_spiros.patch
)
