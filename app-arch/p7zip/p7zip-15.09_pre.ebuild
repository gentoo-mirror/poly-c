...
inherit eutils multilib toolchain-funcs wxwidgets poly-c_ebuilds

DESCRIPTION="Port of 7-Zip archiver for Unix"
HOMEPAGE="http://p7zip.sourceforge.net/"
SRC_URI="mirror://sourceforge/${PN}/${PN}_${MY_PV}_src_all.tar.bz2"
...
RDEPEND="
	kde? ( x11-libs/wxGTK:3.0[X,-odbc] kde-base/kdelibs )
	wxwidgets? ( x11-libs/wxGTK:3.0[X,-odbc] )"
DEPEND="${RDEPEND}
	amd64? ( dev-lang/yasm )
...
src_prepare() {
	epatch \
		"${FILESDIR}"/${PN}-15.09-osversion.patch
		#"${FILESDIR}"/${PN}-9.38.1-CVE-2015-1038.patch
