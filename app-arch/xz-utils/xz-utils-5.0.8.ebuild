...
# $Header: /var/cvsroot/gentoo-x86/app-arch/xz-utils/xz-utils-5.0.8.ebuild,v 1.11 2015/04/04 22:34:26 vapier Exp $
...
pkg_preinst() {
	preserve_old_lib /$(get_libdir)/liblzma$(get_libname 0)
}

pkg_postinst() {
	preserve_old_lib_notify /$(get_libdir)/liblzma$(get_libname 0)
}
