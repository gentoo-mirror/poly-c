...
inherit autotools eutils multilib readme.gentoo-r1 java-pkg-2 xdg-utils poly-c_ebuilds

DESCRIPTION="FOSS Java browser plugin and Web Start implementation"
HOMEPAGE="http://icedtea.classpath.org"
SRC_URI="http://icedtea.classpath.org/download/source/${MY_P}.tar.gz"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-1.6-{launchers,respect-ldflags}.patch
