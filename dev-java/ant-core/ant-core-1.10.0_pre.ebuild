...
inherit eutils java-pkg-2 java-ant-2 prefix versionator poly-c_ebuilds
...
SRC_URI="mirror://apache/ant/source/${MY_P}-src.tar.bz2
	https://dev.gentoo.org/~tomwij/files/dist/ant-1.9.2-gentoo.tar.bz2"
...
DEPEND="|| ( >=virtual/jdk-1.8 dev-java/gcj-jdk )
	!dev-java/ant-tasks
