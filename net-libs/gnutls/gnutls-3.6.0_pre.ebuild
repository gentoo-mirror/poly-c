...
inherit libtool ltprune multilib-minimal versionator poly-c_ebuilds
...
IUSE="+cxx dane doc examples guile +idn nls +openssl pkcs11 sslv2 sslv3 seccomp static-libs test test-full +tls-heartbeat tools valgrind ${IUSE_LINGUAS// / linguas_}"

REQUIRED_USE="
	test-full? ( guile pkcs11 openssl idn seccomp tools )"
