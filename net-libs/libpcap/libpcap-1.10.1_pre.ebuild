...
if [[ ${MY_PV} == *9999* ]] ; then
	...
	SRC_URI="https://www.tcpdump.org/release/${MY_P}.tar.gz -> ${MY_P}-upstream.tar.gz"
	SRC_URI+=" verify-sig? ( https://www.tcpdump.org/release/${MY_P}.tar.gz.sig -> ${MY_P}-upstream.tar.gz.sig )"
