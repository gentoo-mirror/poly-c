...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/php/php-5.6.11.ebuild,v 1.1 2015/07/11 10:59:01 olemarkus Exp $

EAPI=5

inherit eutils autotools flag-o-matic versionator depend.apache apache-module db-use libtool systemd poly-c_ebuilds
...
PHP_RELEASE="php"
[[ ${MY_PV} == ${MY_PV/_alpha/} ]] || PHP_RELEASE="php-pre"
[[ ${MY_PV} == ${MY_PV/_beta/} ]] || PHP_RELEASE="php-pre"
[[ ${MY_PV} == ${MY_PV/_rc/} ]] || PHP_RELEASE="php-pre"
PHP_P="${PN}-${PHP_PV}"
