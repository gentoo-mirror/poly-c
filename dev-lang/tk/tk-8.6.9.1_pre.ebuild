...
inherit autotools eapi7-ver eutils multilib multilib-minimal prefix toolchain-funcs versionator virtualx poly-c_ebuilds

REAL_P="${PN}${MY_PV/_beta/b}"

DESCRIPTION="Tk Widget Set"
HOMEPAGE="http://www.tcl.tk/"
SRC_URI="mirror://sourceforge/tcl/${REAL_P}-src.tar.gz"
...
RDEPEND="
	...
	~dev-lang/tcl-$(ver_cut 1-3 ${MY_PV}):0=[${MULTILIB_USEDEP}]"
DEPEND="${RDEPEND}
...
SPARENT="${WORKDIR}/${PN}$(ver_cut 1-3 ${MY_PV})"
S="${SPARENT}"/unix
