...
src_prepare() {
	...
	replace_patches=(
		"${FILESDIR}/3.7.4/0001-Install-libpythonX.Y.a-in-usr-lib-instead-of-usr-lib.patch"
		"${FILESDIR}/3.7.4/0005-Improve-distutils-C-support.patch"
	)
	local rpatch
	for rpatch in ${replace_patches[@]} ; do
		cp ${rpatch} ${WORKDIR}/patches || die
	done
