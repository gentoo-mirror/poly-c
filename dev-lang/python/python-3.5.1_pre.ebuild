...
inherit autotools eutils flag-o-matic multilib pax-utils python-utils-r1 toolchain-funcs poly-c_ebuilds
...
SRC_URI="http://www.python.org/ftp/python/${MY_PV%_rc*}/${MY_P}.tar.xz
...
src_prepare() {
	...
	EPATCH_EXCLUDE="22_all_tests_environment.patch" \
