...
inherit bash-completion-r1 elisp-common python-any-r1 toolchain-funcs poly-c_ebuilds

if [[ ${MY_PV} == 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/ninja-build/ninja.git"
else
	SRC_URI="https://github.com/ninja-build/${PN}/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
