...
# $Id: 12d34b3af80361c67fefe4980f9c7687827386ae $

EAPI=5

inherit eutils flag-o-matic autotools multilib-minimal poly-c_ebuilds
...
if [[ ${PV} == *9999* ]]; then
	...
	SRC_URI="http://cairographics.org/releases/${MY_P}.tar.xz"
