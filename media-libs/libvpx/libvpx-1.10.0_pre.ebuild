...
EAPI="7"
inherit toolchain-funcs multilib-minimal poly-c_ebuilds
...
# 5. make testdata
# 6. tar -caf libvpx-testdata-${REAL_PV}.tar.xz libvpx-testdata

LIBVPX_TESTDATA_VER=1.10.0

DESCRIPTION="WebM VP8 and VP9 Codec SDK"
HOMEPAGE="https://www.webmproject.org"
SRC_URI="https://github.com/webmproject/${PN}/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz
	test? ( https://www.gentoofan.org/files/${PN}-testdata-${LIBVPX_TESTDATA_VER}.tar.xz )"
