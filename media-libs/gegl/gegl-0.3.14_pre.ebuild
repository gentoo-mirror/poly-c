...
# $Id: a016d4b4facf048624771c1fcf6ebc83e3c75fdf $
...
inherit versionator gnome2-utils eutils autotools python-any-r1 vala poly-c_ebuilds
...
if [[ ${MY_PV} == *9999* ]]; then
	...
	SRC_URI="http://download.gimp.org/pub/${PN}/${PV:0:3}/${MY_P}.tar.bz2"
...
src_prepare() {
	...
	#epatch "${FILESDIR}"/${PN}-0.3.12-g_log_domain.patch
...
src_compile() {
	...
	[[ ${MY_PV} == *9999* ]] && emake ./ChangeLog  # "./" prevents "Circular ChangeLog <- ChangeLog dependency dropped."
}
