...
inherit autotools flag-o-matic gstreamer virtualx poly-c_ebuilds
...
RDEPEND="
	...
	>=media-libs/gst-plugins-base-${PV}_pre:${SLOT}[${MULTILIB_USEDEP},egl?,introspection?,gles2=,opengl=]
	...
	gtk? ( >=media-plugins/gst-plugins-gtk-${PV}_pre:${SLOT}[${MULTILIB_USEDEP}] )
