...
EAPI=5
inherit autotools flag-o-matic toolchain-funcs eutils multilib-minimal poly-c_ebuilds
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.0.4-static-libs.patch
	sed -i \
...
multilib_src_install_all() {
	...
	dodoc {BUGS,CREDITS,README,README-SDL,TODO,WhatsNew}.txt

	sed "s@${D}@@g" -i "${D}"/usr/$(get_libdir)/libSDL2_test.la || die
}
