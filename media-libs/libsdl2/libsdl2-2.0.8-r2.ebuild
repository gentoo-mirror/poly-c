...
# $Id: 4708e54718be362d4754c3d1afda09d07d236875 $
...
IUSE="cpu_flags_x86_3dnow alsa altivec aqua custom-cflags dbus gles haptic +kms libsamplerate +joystick cpu_flags_x86_mmx nas opengl oss pulseaudio +sound cpu_flags_x86_sse cpu_flags_x86_sse2 static-libs +threads tslib udev +video wayland X xinerama xscreensaver"
REQUIRED_USE="
	alsa? ( sound )
	gles? ( video )
	nas? ( sound )
