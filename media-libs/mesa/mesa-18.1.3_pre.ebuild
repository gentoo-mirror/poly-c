...
inherit autotools llvm multilib-minimal python-any-r1 pax-utils ${GIT_ECLASS} poly-c_ebuilds
...
if [[ $PV == 9999 ]]; then
	...
	SRC_URI="https://mesa.freedesktop.org/archive/${REAL_P}.tar.xz"
...
pkg_postinst() {
	...
	if use !bindist; then
		...
		elog "enabled. Please see /usr/share/doc/${MY_P}/patents.txt.bz2 for an"
		elog "explanation."
	fi
}
