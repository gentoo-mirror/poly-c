...
# $Id: 9e5db6adbcb9bc1be73c6138407ac3d0d80ddf2c $

EAPI=6

inherit cmake-utils multilib-minimal multilib multibuild flag-o-matic poly-c_ebuilds
...
if [[ ${PV} = 9999* ]]; then
	...
	SRC_URI="
		https://bitbucket.org/multicoreware/x265/downloads/${PN}_${MY_PV}.tar.gz
		http://ftp.videolan.org/pub/videolan/x265/${PN}_${MY_PV}.tar.gz"
