...
inherit autotools java-pkg-opt-2 flag-o-matic multilib-minimal poly-c_ebuilds
...
if [[ "${PV#9999}" != "${MY_PV}" ]] ; then
	...
	SRC_URI="https://downloads.videolan.org/pub/videolan/libbluray/${MY_PV}/${MY_P}.tar.bz2"
fi
