...
inherit eutils fdo-mime linux-info python-single-r1 udev autotools toolchain-funcs poly-c_ebuilds
...
IUSE="doc fax +hpcups hpijs kde libnotify -libusb0 minimal parport policykit qt4 qt5 scanner snmp static-ppds X"
...
pkg_setup() {
	...
	if ! use qt4 && ! use qt5 ; then
		ewarn "You need USE=qt4 for the hplip GUI."
	fi
